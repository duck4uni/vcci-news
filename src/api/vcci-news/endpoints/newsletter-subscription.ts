 ...
 */
export const patchApiV10NewsletterSubscriptionId = (
    id: string,
    newsletterSubscriptionUpdate: BodyType<NewsletterSubscriptionUpdate>,
 options?: SecondParameter<typeof useCustomClient>,) => {
      
      
      return useCustomClient<PatchApiV10NewsletterSubscriptionId200>(
      {url: `/api/v1.0/newsletterSubscription/${id}`, method: 'PATCH',
      headers: {'Content-Type': 'application/json', },
      data: newsletterSubscriptionUpdate
    },
      options);
    }
 ...
 */
export const deleteApiV10NewsletterSubscriptionId = (
    id: string,
 options?: SecondParameter<typeof useCustomClient>,) => {
      
      
      return useCustomClient<void>(
      {url: `/api/v1.0/newsletterSubscription/${id}`, method: 'DELETE'
    },
      options);
    }
 ...
 */
export const getApiV10NewsletterSubscription = (
    params?: GetApiV10NewsletterSubscriptionParams,
 options?: SecondParameter<typeof useCustomClient>,signal?: AbortSignal
) => {
      
      
      return useCustomClient<ResponseGetAllData>(
      {url: `/api/v1.0/newsletterSubscription`, method: 'GET',
        params, signal
    },
      options);
    }
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetApiV10NewsletterSubscriptionInfiniteQueryKey(params);
    ...
    const queryFn: QueryFunction<Awaited<ReturnType<typeof getApiV10NewsletterSubscription>>> = ({ signal }) => getApiV10NewsletterSubscription(params, requestOptions, signal);
 ...
 */
export const postApiV10NewsletterSubscription = (
    newsletterSubscriptionMutate: BodyType<NewsletterSubscriptionMutate>,
 options?: SecondParameter<typeof useCustomClient>,signal?: AbortSignal
) => {
      
      
      return useCustomClient<PostApiV10NewsletterSubscription200>(
      {url: `/api/v1.0/newsletterSubscription`, method: 'POST',
      headers: {'Content-Type': 'application/json', },
      data: newsletterSubscriptionMutate, signal
    },
      options);
    }
