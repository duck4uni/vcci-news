...
export const postApiV10UserIdResetPassword = (
 ...
 options?: SecondParameter<typeof useCustomClient>,signal?: AbortSignal
      ...
      return useCustomClient<void>(
      {url: `/api/v1.0/user/${id}/reset-password`, method: 'POST', signal
    },
      options);
    }
 ...
 */
export const postApiV10UserIdRole = (
    id: string,
    postApiV10UserIdRoleBody: BodyType<PostApiV10UserIdRoleBody>,
 options?: SecondParameter<typeof useCustomClient>,signal?: AbortSignal
) => {
      
      
      return useCustomClient<void>(
      {url: `/api/v1.0/user/${id}/role`, method: 'POST',
      headers: {'Content-Type': 'application/json', },
      data: postApiV10UserIdRoleBody, signal
    },
      options);
    }
 ...
 */
export const deleteApiV10UserIdRole = (
    id: string,
    deleteApiV10UserIdRoleBody: BodyType<DeleteApiV10UserIdRoleBody>,
 options?: SecondParameter<typeof useCustomClient>,) => {
      
      
      return useCustomClient<void>(
      {url: `/api/v1.0/user/${id}/role`, method: 'DELETE',
      headers: {'Content-Type': 'application/json', },
      data: deleteApiV10UserIdRoleBody
    },
      options);
    }
...
export const patchApiV10UserIdStatus = (
    id: string,
    patchApiV10UserIdStatusBody: BodyType<PatchApiV10UserIdStatusBody>,
 options?: SecondParameter<typeof useCustomClient>,) => {
      
      
      return useCustomClient<void>(
      {url: `/api/v1.0/user/${id}/status`, method: 'PATCH',
      headers: {'Content-Type': 'application/json', },
      data: patchApiV10UserIdStatusBody
    },
      options);
    }
