...
import type { AdminNewsItem, AdminNewsFormValues, AdminNewsImageRef, AdminMediaItem } from "@/api/vcci-news/types/post";
import { ADMIN_NEWS_TYPE_OPTIONS, ADMIN_NEWS_TYPE_LABELS } from "@/api/vcci-news/types/post";
import type { AdminNewsType } from "@/api/vcci-news/types/post";

export type { AdminNewsItem, AdminNewsFormValues, AdminNewsImageRef, AdminMediaItem, AdminNewsType, AdminNewsContentSection, AdminNewsContentImage } from "@/api/vcci-news/types/post";
export { ADMIN_NEWS_TYPE_OPTIONS, ADMIN_NEWS_TYPE_LABELS } from "@/api/vcci-news/types/post";
